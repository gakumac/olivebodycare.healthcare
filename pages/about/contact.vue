  ...
  data() {
    return {
      meta: {
        title: 'お問合せ・メール予約',
        description:
          '整体・骨盤矯正の女性専門の治療院オリーヴボディケア。お問い合わせフォームです。どの整体院に行けば良いのか迷われてる方。当院女性スタッフが丁寧にお答えします。',
        type: 'website',
        url: 'https://olivebodycare.healthscare/about/contact.vue',
