...
import Shinkyumenstruation from '~/components/menu/Shinkyumenstruation.vue'
  ...
  data() {
    return {
      meta: {
        ...
        type: 'website',
        url: 'https://olivebodycare.healthcare/menu/shinkyu/menstruation',
      ...
      itemsB: [
        ...
        },
        {
          text: '鍼灸と生理',
          disabled: true,
          href: '/menu/shinkyu/menstruation'
        }
      ]
    }
  }
