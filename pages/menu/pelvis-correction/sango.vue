...
import Pelvissango from '~/components/menu/Pelvissango.vue'
  ...
  data() {
    return {
      meta: {
        ...
        type: 'website',
        url: 'https://olivebodycare.healthscare/menu/pelvis-correction/sango',
      ...
      itemsB: [
        ...
        },
        {
          text: '産後の骨盤矯正',
          disabled: true,
          href: '/menu/pelvis-correction/sango'
        }
      ]
    }
  }
