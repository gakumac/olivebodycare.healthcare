      ...
      <v-container>
        <v-layout justify-center>
          <v-flex xs12 sm9 md9 lg7 xl5>
            ...
            <hr color="#ffcccc" />
            <p class="mt-4">
              当院では<strong>全員国家資格取得者</strong>の女性スタッフが女性の為の整体治療を行います。
            </p>
            <p>
              <strong>２０年以上の治療経験</strong>があります。おまかせ下さい！
            </p>
            <p>
              おかげさまで、横浜の地で開業して１２年目を向かえ、開業以来治療実績<strong>４８,０００人以上</strong>。<strong>４,３００人</strong>を超える患者様にご来院頂いております。
            </p>
            <p>
        ...
        <v-layout justify-center>
          <v-flex xs12 sm9 md9 lg7 xl5>
            <h3 class="mt-3 text-center">
              ...
              痛みの原因を知り、根本からアプローチする施術を行います。
            </h3>
            <hr color="#ffcccc" />
            <p class="mt-4">
              当院では癒しと共に、<strong>根本治療</strong>を行います
            </p>
            <p>
              筋肉・首・肩のこりや痛みに対処する施術を行うのと共に、本来の正常な動きを妨げている原因を見つけ出します。
            </p>
            <p>
              細かな対応で<strong>女性特有の悩み</strong>も考慮しながら整体・骨盤矯正などの施術を行って対処していきます。
            </p>
          </v-flex>
        </v-layout>
        <v-layout justify-center>
      ...
      <v-container>
        <v-layout justify-center>
          <v-flex xs12 sm9 md9 lg7 xl5>
            ...
            <hr color="#ffcccc" />
            <p class="mt-4">
              当院では内臓からのヘルプサインに耳をかたむけ、身体の表面だけではなく身体の内側へもアプローチして整える<strong>内臓整体</strong>も取り入れております。
            </p>
            <p>
            ...
            <p>
              また、多くの女性が抱える悩みでもある、冷えやむくみなどの症状にも対処する施術を行っております。
            </p>
          </v-flex>
        </v-layout>
      </v-container>
      ...
      <v-container grid-list-md>
        <v-layout justify-center>
          <v-flex xs12 sm9 md9 lg7 xl5>
            ...
            <hr color="#ffcccc" />
            <p class="mt-4">
              その他、完全予約制での営業となっており待合等、混雑する時間帯が発生する事はございません。
            </p>
            <p>
      ...
      <v-container grid-list-md>
        <v-layout justify-center>
          <v-flex xs12 sm9 md9 lg7 xl5>
            ...
            <hr color="#ffcccc" />
            <p class="mt-4">
              ごく少人数でのアットホームな空間なのでお子様が泣いてしまっても安心です。
            </p>
            <p>
              生後２ヶ月の赤ちゃんもご来院されてます。
            </p>
            <p>
              産後の骨盤矯正の患者様も多数ご来院して頂いております。
            </p>
          </v-flex>
        </v-layout>
        <v-layout justify-center>
      ...
      <v-container grid-list-md>
        <v-layout justify-center>
          <v-flex xs12 sm9 md9 lg7 xl5>
            ...
            <hr color="#ffcccc" />
            <p class="mt-4">
              たまプラーザ本店は東急田園都市線たまプラーザ駅より徒歩２分、メディカルモール内の治療院です。
            </p>
            <p class="mt-4">
              横浜美しが丘店は東急田園都市線たまプラーザ駅北口より徒歩３分です。
            </p>
            <p>
              横浜青葉台店は東急田園都市線青葉台駅より徒歩３分です。
            </p>
            <p>
              札幌円山店は東西線円山公園駅徒歩５分です。
            </p>
            <p>
              川崎宮崎台店は東急田園都市線宮崎台駅より徒歩３分です。
            </p>
            <p>
              疲れている時は駅チカが便利！！
            </p>
      ...
      <v-container>
        <v-layout justify-center>
          <v-flex xs12 sm9 md9 lg7 xl5>
            ...
            <hr color="#ffcccc" />
            <p class="mt-4">
              当院では24時間WEB予約に対応しております。
            </p>
            <p>
              残数カレンダーからご都合の良いお日にち・お時間のご予約が可能かどうか確認でき、整体・骨盤矯正・マッサージ・鍼灸などのお好みの施術予約をその場でお取りする事が出来ます。マイページからご自身でのキャンセルにも対応しております。
            </p>
            <p>
